    ...
    <div className="min-h-screen bg-white text-zinc-900 antialiased">
      ...
      <header className="border-b border-zinc-100 sticky top-0 bg-white/90 backdrop-blur-md z-20">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <nav aria-label="Main navigation" className="flex items-center gap-0.5 text-sm">
      ...
      <section className="border-y border-zinc-100 bg-zinc-50">
        <div className="max-w-6xl mx-auto px-6 py-5">
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3">
            ...
            <div className="flex items-center gap-1.5 text-sm text-zinc-500">
              <svg aria-hidden="true" className="w-3.5 h-3.5 text-zinc-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {FEATURES.map(f => (
            ...
            >
              <div aria-hidden="true" className={`w-9 h-9 rounded-lg flex items-center justify-center mb-3.5 ${f.iconBg}`}>
                {f.icon}
              </div>
